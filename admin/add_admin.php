...
<html>
  ...
  <body class="w3-light-grey">
    ...
    <?php
        ...
        if(mysql_query("insert into user(fullname, email, phone, password, type, img) values('$fullname', '$email', '$phone', '$password', 'Admin', 'PSX_20150202_114046.jpg')"))
          {
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
      ...
      <div class="w3-bar-block">
        ...
        <a href="add_admin.php" class=" w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-universal-access"></i> Add Admin</a>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <form action="" class="w3-card-2 w3-light-grey w3-text-blue w3-padding" method="post">
        <div class="w3-container w3-blue-grey w3-padding w3-padding-left"><p style="font-size: 20px; font-family: Sanchez"><i class="w3-xlarge fa-fw fa fa-superpowers"></i> Add New Admin</p></div>
      <div class="w3-row w3-section" style="margin-left: 5%; width: 80%">
        <div class="w3-col" style="width:20%; font-size: 15px; padding-top: 8px;">Fullname</div>
        <div class="w3-rest" >
          <input type="text" class="w3-input w3-border" name="fullname" type="text" value="" required>
        </div>
      </div>

      <div class="w3-row w3-section" style="margin-left: 5%; width: 80%">
        <div class="w3-col" style="width:20%; font-size: 15px; padding-top: 8px;">phone</div>
        <div class="w3-rest" >
          <input type="number" class="w3-input w3-border" name="phone" type="text" value="" required>
        </div>
      </div>

      <div class="w3-row w3-section" style="margin-left: 5%; width: 80%">
        <div class="w3-col" style="width:20%; font-size: 15px; padding-top: 8px;">Email</div>
        <div class="w3-rest" >
          <input type="email" class="w3-input w3-border" name="email" type="text" value="" required>
        </div>
      </div>

      <div class="w3-row w3-section" style="margin-left: 5%; width: 80%">
        <div class="w3-col" style="width:20%; font-size: 15px;">Password</div>
        <div class="w3-rest" >
          <input type="password" class="w3-input w3-border" name="password" type="text" value="" required>
        </div>
      </div>
      ...
      <div class="w3-row w3-section" style="margin-left: 5%; width: 80%">
        ...
        <div class="w3-rest" >
          <button type="submit" name="save"  class="w3-btn-block w3-section w3-blue w3-ripple w3-padding">Save</button>
        </div>
      </div>
      </form>
    </div>
