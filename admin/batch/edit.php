...
<!DOCTYPE html>
<html>
<title>Edit Batch | <?php echo $row['stitle'] ?></title>
<meta charset="UTF-8">
...
if(mysql_query("UPDATE batch SET batch_id1='$batchid', subject_name='$subject', venue_name='$venue', district='$district', company_name='$company', start='$start', end='$end', user_id='$id6' WHERE primary_id1=$id"))
{	
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-bars"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="batchid" type="text" value="<?php echo $row4['batch_id1']; ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-superpowers"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="subject" type="text" value="<?php echo $row4['subject_name']; ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-info-circle"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="venue" type="text" value="<?php echo $row4['venue_name']; ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-circle"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="district" type="text" value="<?php echo $row4['district']; ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-pencil"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="company" type="text" value="<?php echo $row4['company_name']; ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-calendar w3-text-green"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="start" type="date" value="<?php echo $row4['start']; ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-calendar w3-text-red"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="end" type="date" value="<?php echo $row4['end']; ?>">
    </div>
</div>
...
<option value="" disabled selected><?php echo $row7['fullname']; ?></option>
<?php
