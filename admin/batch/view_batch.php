...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="../profile.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw
...
<!--add -->
<!--view-->
<div class="w3-container w3-blue-grey w3-padding w3-padding-left"><p style="font-size: 20px; font-family: Sanchez"><i class="w3-xlarge fa-fw fa fa-eye"></i> View Batch</p></div>

<?php
$per_page = 20;
$result3 = mysql_query("SELECT * FROM batch Order By batch_id1 ASC");
...
?>
<tr class="w3-blue w3-padding"> <th>Batch ID</th>  <th>Subject</th> <th>District</th> <th>Status</th> <th>Trainer</th> <th>Details</th> </tr>
<?php
...
echo '<td>' . mysql_result($result3, $i, 'district') . '</td>';
echo '<td>' . mysql_result($result3, $i, 'batch_status') . '</td>';
$person1=mysql_result($result3, $i, 'user_id');
$result6 = mysql_query("SELECT * FROM user WHERE type='Trainer' AND id='$person1'");
$row6=mysql_fetch_array($result6);
echo '<td>' . $row6['fullname'] . '</td>';
...
echo '<td><div class="w3-dropdown-hover">
    ...
    <div class="w3-dropdown-content w3-border" style="right:0">
	  <a href="view.php?id=' . mysql_result($result3, $i, 'primary_id1') . '"><i class="fa fa-eye"></i> View</a>
      <a href="edit.php?id=' . mysql_result($result3, $i, 'primary_id1') . '"><i class="fa fa-pencil"></i> Edit</a>
      <a href="delete.php?id=' . mysql_result($result3, $i, 'primary_id1') . '"><i class="fa fa-trash-o"></i> Delete</a>
    </div>
    </div></td>';
echo "</tr>";
}
