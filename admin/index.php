...
<html>
  ...
  <body class="w3-light-grey">
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="w3-quarter">
          ...
          <div class="w3-accordion w3-half w3-red w3-border">
            ...
            <div id="Demo1" class="w3-accordion-content w3-light-grey">
              <?php
              $sql6="SELECT DISTINCT district FROM batch WHERE batch_status='Online' ORDER BY district ASC";
              $result6=mysql_query($sql6);
              while ($rows6 = mysql_fetch_array($result6)) { ?>

              <div class='w3-dropdown-hover' style='width: 100%;'><button class='w3-btn-block w3-light-grey w3-left-align' style='font-size: 12px;'><i class='fa fa-circle w3-text-green'></i><?php echo $rows6['district'] ?></button>
                
                <?php
                $district=$rows6['district'];
                $sql_venue="SELECT DISTINCT venue_name FROM batch WHERE batch_status='Online' and district='".$district."' ORDER BY subject_name ASC";
                $result_venue=mysql_query($sql_venue);
                while ($rows_venue = mysql_fetch_array($result_venue)) {
                ?>
                <div class='w3-dropdown-content w3-border' style='margin-left: 120px; margin-top: -30px;'>

                  <div class='w3-dropdown-hover' style='width: 100%;'><button class='w3-btn-block w3-light-grey' style='font-size: 12px;'><i class='fa fa-circle w3-text-green'></i> <?php echo $rows_venue['venue_name'] ?></button>
                </div>
              </div>
      ...
      <div class="w3-quarter">
        <a href="trainer/view_trainer.php" style="text-decoration: none;">
      ...
      <div class="w3-quarter">
        <a href="student/view_student.php" style="text-decoration: none;" >
