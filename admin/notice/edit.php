...
<!DOCTYPE html>
<html>
<title><?php echo $title4 ?> | Edit Notice</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	...
	<a href="index.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bars fa-fw"></i> Batch</a>
...
{
$id = $_GET['id'];
$result6 = mysql_query("SELECT * FROM notice WHERE notice_id=$id")
or die(mysql_error());
...
if (isset($_POST['submit']))	
{
 $title = $_POST['title'];
 $notice = $_POST['notice'];
if(mysql_query("UPDATE notice SET title='$title', notice='$notice' WHERE notice_id=$id"))
{	
?>
<script>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-bell"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="title" type="text" value="<?php echo $title4 ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-envelope-o"></i></div>
    <div class="w3-rest">
      <textarea cols="130" rows="10" class="w3-input w3-border" name="notice" type="text"><?php echo $notice4 ?></textarea> 
    </div>
</div>
