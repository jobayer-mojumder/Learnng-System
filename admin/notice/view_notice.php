...
echo '<td><div class="w3-dropdown-hover">
    ...
    <div class="w3-dropdown-content w3-border" style="right:0">
	  <a href="view.php?id=' . mysql_result($result3, $i, 'notice_id') . '"><i class="fa fa-eye"></i> View</a>
      <a href="edit.php?id=' . mysql_result($result3, $i, 'notice_id') . '"><i class="fa fa-pencil"></i> Edit</a>
      <a href="delete.php?id=' . mysql_result($result3, $i, 'notice_id') . '"><i class="fa fa-trash-o"></i> Delete</a>
    </div>
    </div></td>';
echo "</tr>";
}
