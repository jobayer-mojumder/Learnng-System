...
<html>
<head>
<title>View Student | <?php echo $row['stitle'] ?></title>
<meta charset="UTF-8">
...
<!--add-->
<div class="w3-container w3-blue-grey w3-padding w3-padding-left"><p style="font-size: 20px; font-family: Sanchez"><i class="w3-xlarge fa-fw fa fa-plus-circle"></i> Add Student</p></div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="nid" type="text" placeholder="NID" required>
    </div>
</div>
...
<?php
$sql2 = "SELECT batch_id1 FROM batch ORDER BY batch_id1 ASC";
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-adjust"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="project" type="text" placeholder="Total Project" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-flag"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="pat" type="text" placeholder="Profile 1 Title" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-info-circle"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="pal" type="text" placeholder="Profile 1 Link with http/https" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-flag"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="pbt" type="text" placeholder="Profile 2 Title" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-info-circle"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="pbl" type="text" placeholder="Profile 2 Link with http/https" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-flag"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="pct" type="text" placeholder="Profile 3 Title" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-info-circle"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="pcl" type="text" placeholder="Profile 3 Link with http/https" required>
    </div>
</div>
