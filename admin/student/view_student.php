...
<!--view-->
<div class="w3-container w3-blue-grey w3-padding w3-padding-left"><p style="font-size: 20px; font-family: Sanchez"><i class="w3-xlarge fa-fw fa fa-eye"></i> View Student</p></div>
<?php
$per_page = 20;
$result3 = mysql_query("SELECT * FROM user Where type='Student' Order By id Desc");
