...
<!DOCTYPE html>
<html>
<title>Trainer Details | <?php echo $row['stitle'] ?></title>
<meta charset="UTF-8">
...
<div class="w3-container w3-blue-grey w3-padding w3-padding-left"><p style="font-size: 20px; font-family: Sanchez"><i class="w3-xlarge fa-fw fa fa-info-circle"></i> Trainer Details</p></div>
<div class="w3-container w3-card-4"><a class="w3-btn w3-white w3-border w3-right" style="margin-right: -17px;" href="view_trainer.php"><i class="fa fa-eye"></i> View All</a></div>
