...
{
$id1 = $_GET['id'];
$result7 = mysql_query("SELECT * FROM user WHERE type='Student' AND id='$id1'")
or die(mysql_error());
$row7 = mysql_fetch_array($result7);
$batch_id=$row7['batch_id'];
...
$total_project = $row7['total_project'];
$nid = $row7['nid'];
$profile1_title = $row7['profile1_title'];
$profile1_link = $row7['profile1_link'];
$profile2_title = $row7['profile2_title'];
$profile2_link = $row7['profile2_link'];
$profile3_title = $row7['profile3_title'];
$profile3_link = $row7['profile3_link'];
$img = $row7['img'];
}
}	
?>
