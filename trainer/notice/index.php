...
<!--add-->
<div class="w3-container w3-blue-grey w3-padding w3-padding-left"><p style="font-size: 20px; font-family: Sanchez"><i class="w3-xlarge fa-fw fa fa-plus-circle"></i> Add Notice For My Students</p></div>
...
echo '<td><a style="text-decoration: none;" href="view.php?id=' . mysql_result($result3, $i, 'notice_id') . '"><button class="w3-btn w3-blue"><i class="fa fa-eye"></i> View</button></a></td>';
echo "</tr>";
}
// close table>
// pagination
